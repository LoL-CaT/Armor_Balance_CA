...
{block "lightview"
	...
	{block "attenuation0" optional
		{param "value" blockinfo float {default 0.5}}
	}
	{block "attenuation1" optional
		{param "value" blockinfo float {default 0}}
	}
	{block "attenuation2" optional
		{param "value" blockinfo float {default 0}}
	}
...
{block "visualizer"
	{block "stage" multi
		...
		{block "flags" optional
			{param "flags" blockinfo set {values "killparticle" "matchsprites" "randomsprites" "ground" "trace"}}
		}
